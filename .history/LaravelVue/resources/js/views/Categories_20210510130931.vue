...
<script>
    ...
    export default {
        ...
        methods:{
            loadCategories: async function(){   // 載入資料的函式呼叫
                try {
            ...
            },hideNewCategoryModal(){   // 隱藏 新增資料的彈跳視窗
                this.$refs.NewCategoryModal.hide();
            },showNewCategoryModal(){   // 顯示 新增資料的彈跳視窗
                this.$refs.NewCategoryModal.show();
            },createCategory: async function(){ // 新增資料的函式呼叫
            ...
            },deleteCategory: async function(test){ // 刪除資料的函式呼叫
            ...
            },hideEditCategoryModal(){  // 隱藏 更新資料的彈跳視窗
                this.$refs.EditCategoryModal.hide();
            },showEditCategoryModal(){  // 顯示 更新資料的彈跳視窗
                this.$refs.EditCategoryModal.show();
            },EditCategory(test){   // 複製 要更新的資料
                this.editData = {...test};
                this.showEditCategoryModal();

            },EditAttachImage(){    // 更新的資料的圖片檔案處理
            ...
            },UpdateCategory:async function(){  // 更新資料的函式呼叫
                try {
                    let formData = new FormData();
