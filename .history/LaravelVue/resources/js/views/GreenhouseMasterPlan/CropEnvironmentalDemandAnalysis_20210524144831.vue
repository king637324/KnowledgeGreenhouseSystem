                        ...
                        <b-card-text>
                            <div class="d-flex justify-content-between">
                                <div class="p-2 bd-highlight">
                                    ...
                                    <br>
                                    <a class="btn btn-success mr-auto p-2 bd-highlight text-white" href = "/#/GreenhouseMasterPlan/CropEnvironmentalDemandAnalysis" target="_blank" style="font-size:1.8vmin; font-family:Microsoft JhengHei;">OO歷史日溫</a>
