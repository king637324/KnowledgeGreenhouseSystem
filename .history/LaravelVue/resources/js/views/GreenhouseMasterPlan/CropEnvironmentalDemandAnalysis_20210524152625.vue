                        ...
                        <b-card-text>
                            <div class="d-flex justify-content-between">
                                <div class="p-2 bd-highlight">
                                    ...
                                    <br><br>
                                    <a class="btn btn-primary mr-auto p-2 bd-highlight text-white" :href="weatherlink" target="_blank" style="font-size:1.8vmin; font-family:Microsoft JhengHei;">{{this.selectRegion}}歷史日溫</a>
