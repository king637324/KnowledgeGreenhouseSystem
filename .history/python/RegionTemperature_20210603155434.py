    ...
    for i in range(0,len(result),1):
        ...
        if result[i][1] == result[i][2]:
            ...
            for j in range(1,13,1):
                # 平均溫度              //*[@id="rso"]/div[1]/div/div/div/div[1]/div/div/div/div[2]/div[1]/div/g-expandable-container/div/div[1]/g-expandable-content[2]/span/div[1]/div[2]/span/div/span[2]/span
                test = selector.xpath('//*[@id="rso"]/div[1]/div/div/div[1]/div/div/div/div[2]/div[1]/div/g-expandable-container/div/div[1]/g-expandable-content[2]/span/div[' + str(j) + ']/div[2]/span/div/span[2]/span')
                print(test[0].text)
                test = test[0].split(" /")[0]
                Hightlist.append(test)
                # 平均低溫
                test = selector.xpath('//*[@id="rso"]/div[1]/div/div/div[1]/div/div/div/div[2]/div[1]/div/g-expandable-container/div/div[1]/g-expandable-content[2]/span/div[' + str(j) + ']/div[2]/span/div/span[2]/span/text()')
                test = test[0].split("/ ")[1]
                Lowlist.append(test)
