...
export default {
    data(){
        return{
            ...
            selectglass:[], //被選擇到的批覆膜
            selectPipeRank:[], //排名功能
            selectPipeRankValue:[], //排名功能
            PipeSpeed:null, //透光損失
            PipeStructuralRisk:null, //結構風險
            PipeCorrosive:null, //作業難度
            PipeWeightiness:null, //成本性
            PipeCost:null, //副作用
            PipeTotal:null, //總共

            CoatingFilmJSON:[], //所有披覆膜材料JSON
...
<<<<<<< HEAD
            ...
            softcontent:[], //軟性薄膜知識庫
            hardcontent:[], //硬質塑膠知識庫
            glassshow:true, //披覆膜顯示
            softshow:false, //軟性薄膜顯示
            hardshow:false, //硬質塑膠顯示
