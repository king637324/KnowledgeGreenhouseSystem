    ...
    <div>
        ...
        <v-container-fluid>
            <v-row>
                ...
                <v-col md="1"><button type="button" class="btn btn-secondary" @click="selectAll">全部勾選</button></v-col>
            </v-row>
            <v-row>
                <v-col md="2">
                    <h3>
        ...
        <b-card-group deck id="簡易型溫室">
            ...
            >
                <template #header>
                    <h6 class="mb-0"><b-icon icon="building"></b-icon> 簡 易 型 溫 室  設 計 比 較</h6>
                </template>
                <b-card-text>
        ...
        <b-card-group deck id="簡易型溫室">
            ...
            >
            <template #header>
                <h6 class="mb-0"><b-icon icon="building"></b-icon> 強 固 型 溫 室 設 計 比 較</h6>
            </template>
            <b-card-text>
...
export default {
    ...
    methods:{
        ...
        },updateChart(){    // 根據所勾選的資料，更新溫室型式的表格顯示
            var DataChart=[];
